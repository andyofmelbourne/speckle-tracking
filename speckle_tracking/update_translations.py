...
def update_translations(data, mask, W, O, pixel_map, n0, m0, dij_n):
    ...
    m    = (det != 0)
    dij_nout[m, 0] = (-2*C[1] * C[2] +   C[4] * C[3])[m] / det[m] + dij_n[m, 0]
    dij_nout[m, 1] = (   C[4] * C[2] - 2*C[0] * C[3])[m] / det[m] + dij_n[m, 1]
