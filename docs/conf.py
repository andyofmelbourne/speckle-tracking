...
project = 'speckle-tracking'
copyright = '2018, Andrew James Morgan'
...
htmlhelp_basename = 'speckle-trackingdoc'
...
latex_documents = [
    (master_doc, 'speckle-tracking.tex', 'speckle-tracking Documentation',
     'Andrew James Morgan', 'manual'),
]
...
man_pages = [
    (master_doc, 'speckle-tracking', 'speckle-tracking Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'speckle-tracking', 'speckle-tracking Documentation',
     author, 'speckle-tracking', 'One line description of project.',
     'Miscellaneous'),
]
